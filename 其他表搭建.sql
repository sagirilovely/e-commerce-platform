...
-- 添加一个例子
insert into purchasers(password,email,created_time,profile_photo,nickname,receiver_address,shopping_trolley,token) values('mima','123456@qq.com','2022-01-01','123.png','和泉纱雾','霓虹','1,4,6,3','gasgeg235gs');
-- 添加一个例子
insert into merchants(password,email,created_time,profile_photo,nickname,certificate,token) values('mima','123456@qq.com','2022-01-01','123.png','和泉纱雾','123.png','gasgeg235gs');
-- 添加一个例子
insert into administrators(password,created_time,profile_photo,nickname,token) values('mima','2022-01-01','123.png','和泉纱雾','gasgeg235gs');
-- 添加一个例子
